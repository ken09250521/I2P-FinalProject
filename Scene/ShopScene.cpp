...
void ShopScene::Initialize() {
    ...
    AddNewObject(new Engine::Label("Back", "ferrum.otf", 48, halfW, halfH * 3 / 2, 0, 0, 0, 255, 0.5, 0.5));

    Slider *sliderBGM, *sliderSFX;
    sliderBGM = new Slider(40 + halfW - 95, halfH - 50 - 2, 190, 4);
    sliderBGM->SetOnValueChangedCallback(
            std::bind(&ShopScene::BGMSlideOnValueChanged, this, std::placeholders::_1));
    ...
    sliderSFX->SetOnValueChangedCallback(
            std::bind(&ShopScene::SFXSlideOnValueChanged, this, std::placeholders::_1));
...
void ShopScene::BGMSlideOnValueChanged(float value) {
    AudioHelper::ChangeSampleVolume(bgmInstance, value);
    AudioHelper::BGMVolume = value;
}

void ShopScene::SFXSlideOnValueChanged(float value) {
